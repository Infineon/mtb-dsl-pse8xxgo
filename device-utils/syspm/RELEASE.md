# Prebuilt Syspm Callback (PSE8XXGO) Implementations Release Notes
Syspm callbacks provides a set of prebuilt implementations for handling DeepSleep entry and exit for supported drivers on PSE8XXGO family of chips.
...
### What Changed?
#### v1.0.0
* Initial release for PSE8xxGO support.
...
* [API Reference Guide](https://infineon.github.io/syspm-callbacks-pse8xxgo/html/modules.html)
