# MTB PSE8xxGO Peripheral Driver Library

### Overview
The ModusToolbox PDL simplifies software development for the PSE8xxGO family of devices.
...
easy-to-use APIs. These are fully documented in the [PDL API Reference Manual](https://infineon.github.io/mtb-dsl-pse8xxgo/html/group__group__pdl__top.html).
...
PSE8xxGO series.
See the [PDL API Reference Manual](https://infineon.github.io/mtb-dsl-pse8xxgo/html/group__group__pdl__top.html) for more detailed information.
...
See [PDL API Reference](https://infineon.github.io/mtb-dsl-pse8xxgo/html/group__group__pdl__top.html) for the list of drivers.

### Quick Start
See the [PDL API Reference Manual Getting Started section](https://infineon.github.io/mtb-dsl-pse8xxgo/html/page_getting_started.html) for quick start instructions.

### More information
* [Peripheral Driver Library Release Notes](./RELEASE.md)
* [Peripheral Driver Library API Reference Manual](https://infineon.github.io/mtb-dsl-pse8xxgo/html/group__group__pdl__top.html)
